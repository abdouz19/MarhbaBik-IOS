...
import 'package:marhba_bik/screens/traveler/detailed_screens/sending_car_request.dart';
import 'package:material_design_icons_flutter/material_design_icons_flutter.dart';

class CarDetailedScreen extends StatefulWidget {
  const CarDetailedScreen({super.key, required this.car});

  final Car car;

  @override
  State<CarDetailedScreen> createState() => _CarDetailedScreenState();
}
...
class _CarDetailedScreenState extends State<CarDetailedScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String model = widget.car.model;
    String description = widget.car.description;
    String brand = widget.car.brand;
    String wilaya = widget.car.wilaya;
    String price = widget.car.price;
    int capacity = widget.car.capacity;
    String ownerFirstName = widget.car.ownerFirstName;
    String ownerLastName = widget.car.ownerLastName;
    String ownerProfilePicture = widget.car.ownerProfilePicture;
