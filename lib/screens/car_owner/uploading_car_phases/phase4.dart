...
class UploadingCarFourthPhase extends StatefulWidget {
  final List<XFile?> selectedImages;
  final Function(int, XFile?) onImageSelected;

  const UploadingCarFourthPhase({
    super.key,
  ...
  @override
  State<UploadingCarFourthPhase> createState() =>
      _UploadingCarFourthPhaseState();
}

class _UploadingCarFourthPhaseState extends State<UploadingCarFourthPhase> {
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          Text(
            'On y est presque ! Faites briller votre voiture avec de belles photos !',
          ...
          Text(
            'Donnez vie à votre voiture avec 3 photos captivantes',
